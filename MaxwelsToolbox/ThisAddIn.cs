...
//Specification of the addin
//Two images of same size on two different slides having have to be completely aligned including size, 
//position, crop and rotation
//Two different images with different croppings should be aligned in position and size by either width
//or height
//Position should be the center of the visible part of the image
